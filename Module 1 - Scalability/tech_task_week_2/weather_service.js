        ...
        switch (name) {
            ...
            case "request":
		        ...
		        if(temp > 20 && rain < 50 && wind > 30){
		            warningMessage = `Weather Warning. Fire Warning Level: ${currentFireWarning}`;
		        } 
                else {
                    warningMessage = `Everything is fine. Fire Warning Level: ${currentFireWarning}`;
                }
                
                result = `Area: ${requestedArea}, Temp: ${temp}, Rain: ${rain}, Wind: ${wind}, Fire Warning Level: ${result}`;
                console.log(result);
